...
const sheetURL = `https://sheets.googleapis.com/v4/spreadsheets/${sheetID}/values/partesChicasRO?key=${apiKey}`;
...
function displayProducts(products) {
    ...
    const defaultImageUrl = "./assetes/no-image.avif";
...
document.getElementById('send-order').addEventListener('click', () => {
    ...
    const whatsappURL = `https://wa.me/3413514698?text=${encodeURIComponent(message)}`;
